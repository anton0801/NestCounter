...
final class UserDefaultsStorageService: StorageService {
    private let store = UserDefaults(suiteName: "group.nestcounter.core")!
    private let cache = UserDefaults.standard
    
    private enum Key {
        static let tracking = "nc_tracking_payload"
        static let navigation = "nc_navigation_payload"
        static let endpoint = "nc_endpoint_target"
        static let mode = "nc_mode_active"
        static let firstLaunch = "nc_first_launch_flag"
        static let permGranted = "nc_perm_granted"
        static let permDenied = "nc_perm_denied"
        static let permDate = "nc_perm_date"
    }
    ...
    func loadState() -> StoredData {
        ...
        return StoredData(
            ...
            permission: StoredData.PermissionState(
                isGranted: granted,
                isDenied: denied,
                lastAsked: date
            )
